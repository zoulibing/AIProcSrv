...
void* IMemoryPool::malloc(size_t size)
{
	m_mutex.lock();
...
MemoryChunk* IMemoryPool::matchChunk(size_t size)
{
...
void IMemoryPool::free(void* memory)
{
	m_mutex.lock();
